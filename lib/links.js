...
/**
 * links.json'u sitenin kendi statik dosyalarından okur.
 * @param {string|URL} baseUrl - isteğin adresi; /links.json buna göre çözülür
 */
export async function loadLinks(baseUrl) {
	const target = new URL("/links.json", baseUrl);
